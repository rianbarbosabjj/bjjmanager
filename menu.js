...
const injetarEstilosGlobais = () => {
    if (!document.getElementById('bjj-global-styles')) {
        ...
        style.innerHTML = `
            ...
            /* ==========================================\n               DARK MODE V2 - COMPONENTES BJJ MANAGER\n               Corrige componentes com fundos próprios que não\n               usam as classes utilitárias bg-white/bg-slate-*\n               ========================================== */\n\n            /* Componentes reutilizados nas telas novas */\n            html.dark .dashboard-hero:not(.ignorar-dark),\n            html.dark .metric-card:not(.ignorar-dark),\n            html.dark .section-card:not(.ignorar-dark),\n            html.dark .quick-action:not(.ignorar-dark) {\n                background: #0f172a !important;\n                background-color: #0f172a !important;\n                border-color: #1e293b !important;\n                color: #f8fafc !important;\n                box-shadow: 0 10px 30px -24px rgba(0,0,0,.85) !important;\n            }\n\n            html.dark .dashboard-hero:not(.ignorar-dark) {\n                background: linear-gradient(135deg, #0f172a 0%, #111827 100%) !important;\n                border-color: #1e293b !important;\n            }\n\n            html.dark .quick-action:not(.ignorar-dark):hover {\n                background: #1e293b !important;\n                border-color: #334155 !important;\n            }\n\n            html.dark .metric-card::after { opacity: .42; }\n\n            /* Gestão de Turmas */\n            html.dark #turmas-header,\n            html.dark #turmas-toolbar,\n            html.dark .turma-detail-header,\n            html.dark .turma-students-panel,\n            html.dark .turma-enroll-block,\n            html.dark .turma-students-toolbar,\n            html.dark .turma-students-list {\n                background: #0f172a !important;\n                background-color: #0f172a !important;\n                border-color: #1e293b !important;\n            }\n\n            html.dark #turmas-toolbar {\n                background: #111827 !important;\n            }\n\n            html.dark .turma-enroll-block {\n                background: #111827 !important;\n            }\n\n            html.dark #painel-lista,\n            html.dark #painel-detalhe {\n                border-color: #1e293b !important;\n            }\n\n            html.dark .card-turma {\n                border-color: #1e293b !important;\n            }\n\n            html.dark .card-turma:hover {\n                border-color: #334155 !important;\n            }\n\n            html.dark .view-button[aria-pressed=\"true\"] {\n                background: #020617 !important;\n                color: #f8fafc !important;\n                border-color: #334155 !important;\n            }\n\n            /* Histórico de Graduações */\n            html.dark #cabecalho-atleta,\n            html.dark #form-evolucao,\n            html.dark #card-timeline,\n            html.dark #painel-lista {\n                background: #0f172a !important;\n                background-color: #0f172a !important;\n                border-color: #1e293b !important;\n            }\n\n            html.dark #painel-lista button.atleta-item[aria-current=\"true\"] {\n                background: rgba(8,145,178,.16) !important;\n                color: #f8fafc !important;\n                box-shadow: inset 3px 0 0 #06b6d4 !important;\n            }\n\n            html.dark #painel-lista button.atleta-item:not([aria-current=\"true\"]):hover {\n                background: #1e293b !important;\n            }\n\n            html.dark .timeline-item::before {\n                background-color: #334155 !important;\n            }\n\n            html.dark .timeline-item .ring-white {\n                --tw-ring-color: #0f172a !important;\n            }\n\n            /* Classes Tailwind com transparência usadas nas telas novas. */\n            html.dark #turmas-toolbar[class*=\"bg-slate-50/\"],\n            html.dark .turma-enroll-block[class*=\"bg-slate-50/\"] {\n                background-color: #111827 !important;\n            }\n\n            /* Mantém campos desabilitados legíveis no dark mode */\n            html.dark input:disabled:not(.ignorar-dark),\n            html.dark select:disabled:not(.ignorar-dark),\n            html.dark textarea:disabled:not(.ignorar-dark) {\n                background-color: #1e293b !important;\n                color: #94a3b8 !important;\n                opacity: 1 !important;\n            }\n\n            /* Separadores e barras de progresso */\n            html.dark .bg-slate-100:not(.ignorar-dark),\n            html.dark .bg-slate-200:not(.ignorar-dark) {\n                background-color: #1e293b !important;\n            }\n\n            /* IMPRESSÃO */\n            @media print {
